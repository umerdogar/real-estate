...
import {
	favPropertyListingThunk
} from "../../Redux/Thunk/Property"
import { connect } from "react-redux"
import { useNavigate } from "react-router-dom"
import PaginatedItems from "../../components/Pagination/PaginatedItems"
import { singlePropertyDetail } from "../../Redux/Thunk/Property"
...
const DealerProperties = ({
	...
	const favPropertyList = favPropertyListing 
	console.log("propertyDetail in dealerr", favPropertyList)
								...
								<div className="">
									<div className="">
										<div className="margin-top-15">
											<h3 className="tab-title">Favourite Properties</h3>
											<div className="row margin-bottom-15">
												<div className="col-md-8 col-12">
													<div className="row">
														{favPropertyListing !== undefined && 
						<PaginatedItems itemsPerPage={6} cardDetail={favPropertyList} type={"favProperty"} func = {getPropertyDetail}/>
					}
...
const mapStateToProps = (state) => {
	...
	let {favPropertyListing} = state.propertyReducer
...
const mapDispatchToProps = (dispatch) => {
	return {
		favPropertyListingThunk: () => dispatch(favPropertyListingThunk()),
        singlePropertyDetail: (id, navigate) =>
