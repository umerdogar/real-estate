						...
						<div className="collapse navbar-collapse" id="navbarSupportedContent">
							<ul className="navbar-nav ml-auto main-nav ">
								...
								<li className="nav-item ">
									<a className="nav-link" href="index.html">Plot</a>
								</li>
								<li className="nav-item ">
									<a className="nav-link" href="index.html">Commercial</a>
								</li>
								<li className="nav-item ">
									<a className="nav-link" href="index.html">Rent</a>
								</li>

								<li className="nav-item">
									<img className=" " style={{maxWidth: "150%"}} src={ProfileIcon}
										alt="product-img"/>
								</li>
							</ul>
							...
							<div className="">
								<div className="margin-top-15">
									...
									<div className="bg-blue padding-15">
										<h6 style={{color: "white" ,margin: "0px"}}>Property Type</h6>
									</div>
									<div className="row  margin-bottom-15" style={{marginRight: "0px" ,
									marginLeft: "0px"}}>

										<div className="col-md-2 col-12 border margin-right-20 margin-top-15">
											<lable className="opacity-40 " style={{fontSize: "13px"}}>Purpose</lable>
											...
											<div className="filter-range margin-top-15">
												<div className="filter-range-title">
													...
													<div className="">
														...
														<input className="slider-space" type="number" name="min-price"
															value="1000"/>
														</label>
														<lable className="padding-left-15 ">to</lable>
														<label className="max-price padding-left-15">
															<input className="slider-space align-self-center" type="number"
																name="max-price" value="1000"/>
														</label>
													</div>
										...
										<div className="col-md-2 col-12 border margin-right-20 margin-top-15">
											<lable className="opacity-40 " style={{fontSize: "13px"}}>City</lable>
											<select className=" form-control p-2 w-100 my-2 no-border height-45">
										...
										<div className="col-md-3 col-12 border margin-right-20 margin-top-15">
											<lable className="opacity-40 " style={{fontSize: "13px"}}>Property Type</lable>
											<select className=" form-control p-2 w-100 my-2 no-border height-45">
												<option>Home</option>
										...
										<div className="col-md-4 col-12 border margin-right-20 margin-top-15">
											<lable className="opacity-40 " style={{fontSize: "13px"}}>Area(Marla)</lable>
											<div className="filter-range margin-top-15">
												<div className="filter-range-title">
										...
										<div className="col-md-2 col-12 border margin-right-20 margin-top-15">
											<lable className="opacity-40 " style={{fontSize: "13px"}}>Bed</lable>
											<select className=" form-control p-2 w-100 my-2 no-border height-45">
												<option>5</option>
										...
										<div className="col-md-3 col-12 border margin-right-20 margin-top-15">
											<lable className="opacity-40 " style={{fontSize: "13px"}}>Bath</lable>
											<select className=" form-control p-2 w-100 my-2 no-border height-45">
												<option>1</option>
												<option value="1">2</option>
										...
										<div className="col-md-2 col-12 border margin-right-20 margin-top-15">
											<lable className="opacity-40 " style={{fontSize: "13px"}}>Society</lable>
											<select className=" form-control p-2 w-100 my-2 no-border height-45">
									...
									<div className="row margin-bottom-15" >
										...
										<div className="col-md-3 col-3 margin-bottom-5">
											<div
												className="checkbox-custom checkbox-inline1 checkbox-warning box-color">
												<input type="checkbox" id="444" name="checkbox" checked=""/>
									...
									<div className="row margin-bottom-15" >
										<div className="col-md-12">
											<h6 className="margin-top-30">18000 Properties in Islamabad</h6>
											<div className="margin-top-30">

												<div className="nav-tabs-horizontal border">
													<ul className="nav nav-tabs font-weight-600" data-plugin="nav-tabs" role="tablist">
				
														<li style={{padding: "15px"}} className="active" role="presentation"><a data-toggle="tab" href=".tab-List" role="tab" aria-expanded="true">
																Home (8920)</a></li>
				
														<li style={{padding: "15px"}} role="presentation" className=""><a data-toggle="tab" href=".tab-Types" role="tab" aria-expanded="false"> 
																Flats (17283)</a></li>
																<li style={{padding: "15px"}} role="presentation" className=""><a data-toggle="tab" href=".tab-Type1" role="tab" aria-expanded="false">
																	Plots (6723) </a></li>
													...
													<div className="tab-content padding-top-20">
														...
														<div className="tab-pane  tab-List active" role="tabpanel">
															<div className="row">
																<div className="col-md-12">
																	<table
																	...
																	<tbody>
																		...
																		<tr>
																			<td> National Police Foundation(12)</td>
																			<td> National Police Foundation(12)</td>
																			<td> National Police Foundation(12)</td>
																		</tr>
																		<tr>
														...
														<div className="tab-pane tab-Types" role="tabpanel">
															<div className="row">
																<div className="col-md-12">
																	<table
																	className="table margin-bottom-0 table-bordered1     table-condensed   "
														...
														<div className="tab-pane tab-Type1" id="" role="tabpanel">
															<div className="row">
																<div className="col-md-12">
																	<table
																	className="table margin-bottom-0 table-bordered1     table-condensed   "
													...
													<div className="text-center">
														<p className="" style={{color: "rgb(8, 197, 245)"}}><a>View All Location in Islamabad</a></p>
													</div>
										...
										<div className="col-md-4 col-12">
											<div className="row">
												<div className="col-md-12  margin-bottom-15">
													<button type="submit" className="d-block p-4 w-100 my-3 bg-primary text-white border-0 rounded mt-3">Get the latest update about properties
													</button>
													<div className="card">
														<img className="card-img" src={Image1} alt="Vans"/>
