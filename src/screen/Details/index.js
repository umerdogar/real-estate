...
const Details = ({
	...
	const APICall = () => {
		axios
			.post(`http://52.77.156.101:8000/api/v1/property/send/mail/${productId}`, UserInfo)
			.then((res) => {
				Notification("success"," Email Sent Succesfully")
			})
			.catch((error) => {
				console.log(" errorr response", error.msg)
	...
	const handlePost = (e) => {
		e.preventDefault()
		console.log( "UserInfo in handle post " , UserInfo)
		APICall()
	}
	return (
		<>
